(function (exports) {
  ...
  var OptionSet = (function () {
    ...
    optionSet.prototype.register = function register(value) {
      if (value instanceof OptionSet) {
        this.options = this.options.concat(value.options);
      } else {
  ...
  function importExports(dst, module) {
  ...
  exports.importExports = importExports;
  exports.Option = Option;
  exports.OptionSet = OptionSet;
  exports.IndentingWriter = IndentingWriter;
