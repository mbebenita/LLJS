  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "AbstractDeclaratorSuffix": parse_AbstractDeclaratorSuffix,
        "AbstractParameterDeclaration": parse_AbstractParameterDeclaration,
        "AbstractParameterList": parse_AbstractParameterList,
        ...
        "DeclaratorSuffix": parse_DeclaratorSuffix,
        ...
        "FieldDeclaration": parse_FieldDeclaration,
        "FieldDeclarationList": parse_FieldDeclarationList,
        ...
        "TypeReservedWord": parse_TypeReservedWord,
      ...
      function parse_ReservedWord() {
        ...
        if (result6 !== null) {
          ...
          if (result5 !== null) {
            ...
            var result4 = parse_TypeReservedWord();
            if (result4 !== null) {
              var result0 = result4;
            } else {
              var result3 = parse_NullLiteral();
              if (result3 !== null) {
                var result0 = result3;
              } else {
      ...
      function parse_TypeReservedWord() {
        var cacheKey = 'TypeReservedWord@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_SizeofToken() {
        var cacheKey = 'SizeofToken@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_StructToken() {
        var cacheKey = 'StructToken@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_MemberExpression() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result38 = parse_PrimaryExpression();
        if (result38 !== null) {
          var result3 = result38;
        } else {
          var result37 = parse_FunctionExpression();
          if (result37 !== null) {
            var result3 = result37;
          } else {
            var savedPos8 = pos;
            var savedPos9 = pos;
            var result32 = parse_NewToken();
            if (result32 !== null) {
              var result33 = parse___();
              if (result33 !== null) {
                var result34 = parse_MemberExpression();
                if (result34 !== null) {
                  var result35 = parse___();
                  if (result35 !== null) {
                    var result36 = parse_Arguments();
                    if (result36 !== null) {
                      var result30 = [result32, result33, result34, result35, result36];
                    } else {
                      var result30 = null;
                      pos = savedPos9;
                    }
              ...
              if (result25 !== null) {
                ...
                if (result26 !== null) {
                  ...
                  if (result27 !== null) {
                    ...
                    if (result28 !== null) {
                      var result21 = [result23, result24, result25, result26, result27, result28];
                    } else {
                      var result21 = null;
                      pos = savedPos7;
                    }
          ...
          if (result20 !== null) {
            ...
            if (result16 !== null) {
              ...
              if (result17 !== null) {
                ...
                if (result18 !== null) {
                  var result19 = parse_IdentifierName();
                  if (result19 !== null) {
                    var result14 = [result16, result17, result18, result19];
                  } else {
                    var result14 = null;
                    pos = savedPos5;
                  }
      ...
      function parse_CallExpression() {
        ...
        var savedPos10 = pos;
        var savedPos11 = pos;
        var result36 = parse_MemberExpression();
        if (result36 !== null) {
          var result37 = parse___();
          if (result37 !== null) {
            var result38 = parse_Arguments();
            if (result38 !== null) {
        ...
        if (result3 !== null) {
          ...
          if (result32 !== null) {
            var result33 = parse_Arguments();
            if (result33 !== null) {
              var result30 = [result32, result33];
            } else {
              var result30 = null;
              pos = savedPos9;
            }
          ...
          ? (function(base, argumentsOrAccessors) {
                ...
                for (var i = 0; i < argumentsOrAccessors.length; i++) {
                  switch (argumentsOrAccessors[i].type) {
                    ...
                    default:
                      throw new Error(
                        "Invalid expression tag:  " + argumentsOrAccessors[i].type
                      );
                  }
                }
                return result;
      ...
      function parse_LeftHandSideExpression() {
        ...
        var result8 = parse_CallExpression();
        if (result8 !== null) {
          var result0 = result8;
        } else {
          var result7 = parse_NewExpression();
          if (result7 !== null) {
            var result0 = result7;
          } else {
            var savedPos0 = pos;
            ...
            var result3 = result2 !== null
              ? (function(expression) {
                    return savePosition(new UnaryExpression("*", expression));
                  })(result2[2])
              : null;
            if (result3 !== null) {
              var result1 = result3;
      ...
      function parse_UnaryExpression() {
        ...
        var result17 = parse_PostfixExpression();
        if (result17 !== null) {
          var result0 = result17;
        } else {
          var savedPos2 = pos;
          var savedPos3 = pos;
          var result10 = parse_SizeofToken();
          if (result10 !== null) {
            var result11 = parse___();
            if (result11 !== null) {
              if (input.substr(pos, 1) === "(") {
      ...
      function parse_UnaryOperator() {
        ...
        var result12 = parse_DeleteToken();
        if (result12 !== null) {
          var result0 = result12;
        } else {
          var result11 = parse_VoidToken();
          if (result11 !== null) {
            var result0 = result11;
          } else {
            var result10 = parse_TypeofToken();
            if (result10 !== null) {
              var result0 = result10;
            } else {
              var result9 = parse_SizeofToken();
              if (result9 !== null) {
                var result0 = result9;
              } else {
                if (input.substr(pos, 2) === "++") {
      ...
      function parse_CastExpression() {
        var cacheKey = 'CastExpression@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
            ...
            if (result7 !== null) {
              ...
              if (result8 !== null) {
                ...
                if (result9 !== null) {
                  ...
                  if (result10 !== null) {
                    var result11 = parse_CastExpression();
                    if (result11 !== null) {
        ...
        var result4 = result3 !== null
          ? (function(type, expression) {
                return savePosition(new CastExpression(type, expression));
              })(result3[2], result3[6])
          : null;
        if (result4 !== null) {
          var result2 = result4;
      ...
      function parse_MultiplicativeExpression() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_CastExpression();
        if (result3 !== null) {
          var result4 = [];
          var savedPos2 = pos;
          var result6 = parse___();
          if (result6 !== null) {
            ...
            if (result7 !== null) {
              var result8 = parse___();
              if (result8 !== null) {
                var result9 = parse_CastExpression();
                if (result9 !== null) {
                  var result5 = [result6, result7, result8, result9];
                } else {
                  var result5 = null;
                                    ...
                                    if (result4 !== null) {
                                      ...
                                      if (result3 !== null) {
                                        ...
                                        if (result2 !== null) {
                                          ...
                                          var result1 = parse_StructDeclaration();
                                          if (result1 !== null) {
                                            var result0 = result1;
                                          } else {
                                            var result0 = null;;
      ...
      function parse_Type() {
        ...
        var result2 = result1 !== null
          ? (function(name, pointers) {
                var result = {tag: "Type", name:name, pointers: pointers.length};
                return result;
              })(result1[0], result1[2])
          : null;
        if (result2 !== null) {
      ...
      function parse_VariableStatement() {
        ...
        if (result3 !== null) {
          var result4 = parse___();
          if (result4 !== null) {
            var result5 = parse_TypeSpecifier();
            if (result5 !== null) {
              var result6 = parse___();
              if (result6 !== null) {
                var result7 = parse_VariableDeclarationList();
                if (result7 !== null) {
                  var result8 = parse_EOS();
                  if (result8 !== null) {
                    var result1 = [result3, result4, result5, result6, result7, result8];
                  } else {
                    var result1 = null;
      ...
      function parse_EmptyStatement() {
        ...
        var result2 = result1 !== null
          ? (function() { return { tag:  "EmptyStatement" }; })()
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
            ...
            if (result5 !== null) {
              ...
              if (result6 !== null) {
                ...
                if (result27 !== null) {
                  ...
                  if (result28 !== null) {
                    var result29 = parse_TypeSpecifier();
                    if (result29 !== null) {
                      var result30 = parse___();
                      if (result30 !== null) {
                        var result31 = parse_VariableDeclarationListNoIn();
                        if (result31 !== null) {
      ...
      function parse_BreakStatement() {
        ...
        var result2 = result1 !== null
          ? (function(label) {
                return savePosition(new BreakStatement(label !== "" ? label : null));
              })(result1[2])
          : null;
        if (result2 !== null) {
          var result0 = result2;
      ...
      function parse_DebuggerStatement() {
        ...
        var result2 = result1 !== null
          ? (function() { return { tag:  "DebuggerStatement" }; })()
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_StructDeclaration() {
        var cacheKey = 'StructDeclaration@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
            ...
            if (result5 !== null) {
              ...
              if (result6 !== null) {
                ...
                if (result7 !== null) {
                  var result8 = parse___();
                  if (result8 !== null) {
                    var result12 = parse_FieldDeclarationList();
      ...
      function parse_FieldDeclaration() {
        var cacheKey = 'FieldDeclaration@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_TypeSpecifier();
        if (result3 !== null) {
          var result4 = parse___();
          if (result4 !== null) {
            var result5 = parse_Declarator();
            if (result5 !== null) {
              var result1 = [result3, result4, result5];
            } else {
              var result1 = null;
      ...
      function parse_FieldDeclarationList() {
        var cacheKey = 'FieldDeclarationList@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_FieldDeclaration();
        if (result3 !== null) {
          var result4 = [];
          var savedPos2 = pos;
          var result6 = parse___();
          if (result6 !== null) {
            ...
            if (result7 !== null) {
              var result8 = parse___();
              if (result8 !== null) {
                var result9 = parse_FieldDeclaration();
                if (result9 !== null) {
                  var result5 = [result6, result7, result8, result9];
                } else {
                  var result5 = null;
      ...
      function parse_FormalParameterList() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_ParameterDeclaration();
        if (result3 !== null) {
          var result4 = [];
          var savedPos2 = pos;
          var result6 = parse___();
          if (result6 !== null) {
            ...
            if (result7 !== null) {
              var result8 = parse___();
              if (result8 !== null) {
                var result9 = parse_ParameterDeclaration();
                if (result9 !== null) {
                  var result5 = [result6, result7, result8, result9];
                } else {
                  var result5 = null;
      ...
      function parse_Declarator() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result6 = parse_Pointer();
        var result3 = result6 !== null ? result6 : '';
        if (result3 !== null) {
          var result4 = parse___();
          if (result4 !== null) {
            var result5 = parse_DirectDeclarator();
            if (result5 !== null) {
              var result1 = [result3, result4, result5];
            } else {
              var result1 = null;
      ...
      function parse_DirectDeclarator() {
        var cacheKey = 'DirectDeclarator@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result13 !== null) {
          ...
          if (result14 !== null) {
            var result15 = [];
            var result16 = parse_DeclaratorSuffix();
            while (result16 !== null) {
          ...
          if (result4 !== null) {
            ...
            if (result5 !== null) {
              ...
              if (result6 !== null) {
                ...
                if (result7 !== null) {
                  var result8 = [];
                  var result9 = parse_DeclaratorSuffix();
                  while (result9 !== null) {
      ...
      function parse_DeclaratorSuffix() {
        var cacheKey = 'DeclaratorSuffix@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result21 !== null) {
          ...
          if (result22 !== null) {
            var result23 = parse_NumericLiteral();
            if (result23 !== null) {
        ...
        var result20 = result19 !== null
          ? (function(nl) { return { tag: "ArrayDeclarator", Value: nl}; })(result19[2])
          : null;
        if (result20 !== null) {
        ...
        if (result18 !== null) {
          ...
          var result14 = result13 !== null
            ? (function() { return { tag: "ArrayDeclarator" }; })()
            : null;
          if (result14 !== null) {
            var result12 = result14;
          } else {
          ...
          if (result12 !== null) {
            ...
            if (result9 !== null) {
              var result10 = parse_AbstractParameterList();
              if (result10 !== null) {
                if (input.substr(pos, 1) === ")") {
                  var result11 = ")";
                  pos += 1;
      ...
      function parse_ParameterDeclaration() {
        var cacheKey = 'ParameterDeclaration@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_TypeName() {
        ...
        if (result3 !== null) {
          var result4 = parse___();
          if (result4 !== null) {
            var result6 = parse_AbstractDeclarator();
            var result5 = result6 !== null ? result6 : '';
            if (result5 !== null) {
              var result1 = [result3, result4, result5];
            } else {
      ...
      function parse_TypeSpecifier() {
        var cacheKey = 'TypeSpecifier@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_AbstractDeclarator() {
        var cacheKey = 'AbstractDeclarator@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var savedPos1 = pos;
        var savedPos2 = pos;
        var result7 = parse_Pointer();
        if (result7 !== null) {
          var result8 = parse___();
          if (result8 !== null) {
            var result10 = parse_DirectAbstractDeclarator();
      ...
      function parse_DirectAbstractDeclarator() {
        var cacheKey = 'DirectAbstractDeclarator@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result8 !== null) {
          var result9 = parse_AbstractDeclarator();
          if (result9 !== null) {
            if (input.substr(pos, 1) === ")") {
              var result10 = ")";
              pos += 1;
            ...
            if (result10 !== null) {
              ...
              if (result11 !== null) {
                var result12 = [];
                var result13 = parse_AbstractDeclaratorSuffix();
                while (result13 !== null) {
        ...
        if (result5 !== null) {
          ...
          var savedPos0 = pos;
          var result4 = parse_AbstractDeclaratorSuffix();
          if (result4 !== null) {
            var result2 = [];
            while (result4 !== null) {
              result2.push(result4);
      ...
      function parse_AbstractDeclaratorSuffix() {
        var cacheKey = 'AbstractDeclaratorSuffix@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_AbstractParameterList() {
        var cacheKey = 'AbstractParameterList@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_AbstractParameterDeclaration();
        if (result3 !== null) {
          var result4 = [];
          var savedPos2 = pos;
          var result6 = parse___();
          if (result6 !== null) {
            ...
            if (result7 !== null) {
              var result8 = parse___();
              if (result8 !== null) {
                var result9 = parse_AbstractParameterDeclaration();
                if (result9 !== null) {
                  var result5 = [result6, result7, result8, result9];
                } else {
                  var result5 = null;
      ...
      function parse_AbstractParameterDeclaration() {
        var cacheKey = 'AbstractParameterDeclaration@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_Pointer() {
        ...
        var result2 = result1 !== null
          ? (function(p) {
              return {
                tag: "Pointer", count: p !== "" ? p.count + 1 : 1
              };
            })(result1[2])
          : null;
        if (result2 !== null) {
